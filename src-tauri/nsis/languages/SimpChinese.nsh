...
LangString alreadyInstalled ${LANG_SIMPCHINESE} "检测到已有版本"
...
LangString dontUninstall ${LANG_SIMPCHINESE} "覆盖安装"
...
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "检测到已有版本。$\r$\n选择你想要执行的操作后点击下一步以继续。"
...
LangString uninstallBeforeInstalling ${LANG_SIMPCHINESE} "卸载后重新安装"
